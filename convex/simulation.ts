...
export const SCENARIOS = {
  ...
  lightRain: {
    ...
    waterLevel: { min: 10, max: 20 },
    floodProbability: { min: 0.25, max: 0.45 },
    severity: "medium" as const,
  },
  heavyStorm: {
    name: "Heavy Storm",
    description: "Heavy rainfall with high flood risk",
    waterLevel: { min: 25, max: 32 },
    floodProbability: { min: 0.65, max: 0.85 },
    severity: "high" as const,
  },
  floodEvent: {
    name: "Flood Event",
    description: "Critical flooding conditions",
    waterLevel: { min: 35, max: 50 },
    floodProbability: { min: 0.90, max: 0.98 },
